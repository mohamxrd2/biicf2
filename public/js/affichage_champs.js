...
const champPhoto5 = document.getElementById("floating_photo5");
...
const champZoneEco = document.getElementById("floating_zoneco");
...
champPhoto5.style.display = "none"
...
selectType.addEventListener("change", function () {
    if (selectType.value === "services") {
        ...
        champPhoto5.style.display = "block";
