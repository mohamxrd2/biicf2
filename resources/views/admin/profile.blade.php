...
@section('content')
    ...
    <div class="w-full p-6 bg-white rounded-lg shadow-md dark:bg-neutral-800">
        ...
        <div class="flex md:gap-8 gap-4 items-center md:p-8 p-6 md:pb-4">
          <form action="{{ route('admin.updateProfilePhoto', ['admin' => $admin->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="relative md:w-20 md:h-20 w-12 h-12 shrink-0">
                <label for="file" class="cursor-pointer">
                    <img id="img" src="{{ $admin->photo }}" class="object-cover w-full h-full rounded-full" alt="" />
