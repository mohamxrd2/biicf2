            ...
            <ul class="space-y-1.5 ">
                ...
                <li class="hs-accordion @if(request()->route()->getName() == 'admin.produits' || request()->route()->getName() == 'admin.services' ) active @endif" id="account-accordion">
                    <button type="button"
                        ...
                        <svg class="flex-shrink-0 mt-0.5 w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <div id="account-accordion"
                        class="hs-accordion-content w-full overflow-hidden transition-height duration-300 hidden" @if(request()->route()->getName() == 'admin.produits' || request()->route()->getName() == 'admin.services') style="display: block" @endif  >
                        <ul class="pt-2 ps-2">
                            <li>
                ...
                <li class="hs-accordion @if(request()->route()->getName() == 'admin.conso-produit' || request()->route()->getName() == 'admin.conso-service' ) active @endif" id="account-accordion">
                    ...
                    <div id="account-accordion"
                        class="hs-accordion-content w-full overflow-hidden transition-height duration-300 hidden" @if(request()->route()->getName() == 'admin.conso-produit' || request()->route()->getName() == 'admin.conso-service') style="display: block" @endif  >
                        <ul class="pt-2 ps-2">
                            <li>
