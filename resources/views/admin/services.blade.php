                ...
                @foreach ($services as $service)
                    <tr
                        ...
                        <th scope="row"
                            ...
                            <img class="w-10 h-10 rounded-md" src="{{  $service->photo ? $service->photo : asset('img/noimg.jpeg') }}" alt="Jese image">
                            <div class="ps-3">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex">
                                ...
                                <button data-hs-overlay="#hs-delete"
                                    ...
                                    {{-- <form action="{{ route('admin.destroy', $service->id ) }}" method="POST" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                    @csrf
                                    @method('DELETE')
                                    <button class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-800 dark:text-white dark:hover:bg-neutral-800" type="submit" id="confirmDeleteBtn">Supprimer{{ $service->id }}</button>
                                </form> --}}
