...
@section('content')
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex flex-col bg-white p-4 rounded-xl border justify-center">
            <h2 class="text-lg font-medium mb-4"><span class="font-semibold">Titre: </span>{{ $notification->data['nameProd'] }}</h2>
            ...
            <a href="{{ route('biicf.postdet', $notification->data['idProd']) }}" class="mb-3 text-blue-700 hover:underline flex">
                Voir le produit
            ...
            <div class="flex gap-2">
                <form id="form-accepter" action="{{ route('achatD.accepter') }}" method="POST">
                    ...
                    <button id="btn-accepter" type="submit" class="px-4 py-2 text-white bg-green-500 rounded hover:bg-green-700">Accepter</button>
                </form>
                <form id="form-refuser" action="{{ route('achatD.refuser') }}" method="POST">
                    ...
                    <button id="btn-refuser" type="submit" class="px-4 py-2 text-white bg-red-500 rounded hover:bg-red-700">Refuser</button>
                </form>
            </div>
        </div>
