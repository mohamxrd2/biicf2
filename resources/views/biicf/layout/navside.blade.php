                    ...
                    <div class="hs-dropdown relative inline-flex [--placement:bottom-right] pr-4  ">
                        <button id="hs-dropdown-with-header" type="button"
                            ...
                            <img class="inline-block size-[38px] rounded-full ring-2 ring-white dark:ring-gray-800"
                                src="{{ $user->photo }}" alt="Image Description">
                            {{ $user->name }}
        ...
        <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
            <ul class="space-y-1.5 ">
                ...
                @include('admin.components.nav', [
                    ...
                    'iconSvg2' => '<svg class="flex-shrink-0 size-4 "  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                ...
                <hr>
                @include('admin.components.nav', [
                    'routeSelf' => 'biicf.profile',
                    'route' => route('biicf.profile'),
                    'iconSvg2' => '<svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                ...
                <li>
                    <a class="flex items-center gap-x-3.5 py-3 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 "
                        href="#" data-hs-overlay="#hs-sign-out-alert">
